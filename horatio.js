...
Horatio.Wordlists = {
    ...
    /** Negative Adjective */
    negative_adjectives: [ "bad", "cowardly", "cursed", "damned", "dirty", "disgusting", "distasteful", "dusty", "evil", "fat", "fat-kidneyed", "fatherless", "foul", "hairy", "half-witted", "horrible", "horrid", "infected", "lying", "miserable", "misused", "oozing", "rotten", "smelly", "snotty", "sorry", "stinking", "stuffed", "stupid", "vile", "villainous", "worried" ],
    /** Negative Comparatives */
    negative_comparatives: [ "punier", "smaller", "worse" ],
    /** Negative Nouns */
    ...
    positive_comparatives: [ "better", "bigger", "fresher", "friendlier", "nicer", "jollier" ],
    /** Positive Nouns */
    positive_nouns: [ "Heaven", "King", "Lord", "angel", "flower", "happiness", "joy", "plum", "summer's day", "hero", "rose", "kingdom", "pony" ],
    /** Second Person */
